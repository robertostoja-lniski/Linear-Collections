...
{
 //BOOST_CHECK_EQUAL_COLLECTIONS(begin(collection), end(collection), begin(expected), end(expected));
                              ...
                              TestedTypes)
{
  ...
  thenConstructedObjectsCountWas<T>(2);
  thenCopiedObjectsCountWas<T>(1);
  thenAssignedObjectsCountWas<T>(0);
  thenMovedObjectsCountWas<T>(0);
  thenDestroyedObjectsCountWas<T>(1);
}
...
// MOJE TESTY
BOOST_AUTO_TEST_CASE_TEMPLATE(GivenNonEmptyCollection_WhenAppendingBigNumTimes,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
  ...
  for (int i = 0; i < BIG_NUM; i++) {
     collection.append(T(i));
  }
  BOOST_CHECK_EQUAL(collection.getSize(), BIG_NUM);
}
BOOST_AUTO_TEST_CASE_TEMPLATE(GivenNonEmptyCollection_WhenAppendingBigNumTimes_ThenItemsRemoved,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(GivenNonEmptyCollection_WhenAppendingBigNumTimes_ThenComparingBeg,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
  ...
  for (int i = 0; i < BIG_NUM; i++) {
     collection.append(T(500));
  }
  
  BOOST_CHECK_EQUAL(*collection.begin(), 500);
  BOOST_CHECK_EQUAL(*collection.begin()++, 500);
  BOOST_CHECK_EQUAL(*++collection.begin(), 500);
}
BOOST_AUTO_TEST_CASE_TEMPLATE(GivenNonEmptyCollection_WhenAppendingBigNumTimes_ThenComparingEnd,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(GivenNonEmptyCollection_WhenAppendingBigNumTimes_ThenChecksException,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(GivenNonEmptyCollection_WhenAppendingBigNumTimes_ThenSizeIsReduced,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
  ...
  collection.popFirst();
  collection.popLast();
  BOOST_CHECK_EQUAL(collection.getSize(), BIG_NUM - 2);

}
BOOST_AUTO_TEST_CASE_TEMPLATE(GivenNonEmptyCollection_WhenAppendingBigNumTimes_RealTimeSizeReduced,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
